...
export const currentUserHandler = () => {
  return rest.get('*/auth/v1/user', (_, response, context) =>
    response(context.status(200), context.json(mockUser))
  );
};

export const authHandlers = [signupHandler(), currentUserHandler()];
